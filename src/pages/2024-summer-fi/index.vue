...
<template>
  <div ref="page" class="">
    <h1>FinnAcro 2024 kesä infot</h1>
    ...
    <p>FinnAcro eli Finnish Acrobatics Convention kesä 2024! Jyväskylässä jälleen luvassa huippu ohjaajia ja huippua meininkiä.</p>
    <p>Älä menetä ennakkovaraajan etuasi (-40€) ja ilmoittaudu viimeistään pe 10.5.2024. Näin saat leirin hintaan 185€ (norm. 225€).</p>
    <h5>Varausmaksu ja leirimaksun maksaminen</h5>
    <p>Ilmoittautumisen yhteydessä maksat vain varausmaksun 35€. Leirimaksun loppusumma maksetaan maksulinkillä, joka saapuu sähköpostilla 20.5.2024.</p>
    <h5>Ilmoittautumisen peruminen</h5>
    <p>Ilmoittautumisen voi perua 19.5.2024 mennessä veloituksetta. 20.5.2024 alkaen perutuista ilmoittautumisista pidätämme varausmaksun. Perumiset tulee ilmoittaa osoitteeseen jyvaskyla@parkourakatemia.fi.</p>
    <p>FinnAcroa vietetään kesällä to-su 18.-21.7.2024 Jyväskylän Sirkuskoululla. Luvassa paljon treeniä, hauskanpitoa hyvässä porukassa ja hurjasti uutta opittavaa! Leiri on suunnattu aikuisille, mutta 16-17-vuotiaat voivat osallistua huoltajan luvalla ja 12-15-vuotiaat aikuisen seurassa.</p>
