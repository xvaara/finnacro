...
<template>
  <div>
    ...
    <div btn text-sm m="3 t8">
      <router-link to="/reg">
        2023 uusivuosi ilmoittautuminen (registration in finnish)
      </router-link>
    </div>
    <div btn text-sm m="3 t8">
      <router-link to="/info">
    ...
    <div py-4 />
    <div flex gap="3" justify-around flex-wrap>
      <div>
        <a btn text-sm href="https://instagram.com/finn.acro" class="flex-inline">
          <div i-carbon-logo-instagram /> Instagram
        </a>
      </div>
      <div>
